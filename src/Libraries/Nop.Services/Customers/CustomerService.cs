...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        public virtual async Task<int[]> GetCustomerRoleIdsAsync(Customer customer, bool showHidden = false)
        {
            ...
            return await _shortTermCacheManager.GetAsync( async () => await query.ToArrayAsync(), NopCustomerServicesDefaults.CustomerRoleIdsCacheKey, customer, showHidden);
        }
        ...
        public virtual async Task<IList<CustomerRole>> GetCustomerRolesAsync(Customer customer, bool showHidden = false)
        {
            ...
            return await _shortTermCacheManager.GetAsync(
                async () =>
                {
                    return await _customerRoleRepository.GetAllAsync(query => from cr in query
                        join crm in _customerCustomerRoleMappingRepository.Table on cr.Id equals crm.CustomerRoleId
                        where crm.CustomerId == customer.Id &&
                              (showHidden || cr.Active)
                        select cr);
                }, NopCustomerServicesDefaults.CustomerRolesCacheKey, customer, showHidden);
        }
